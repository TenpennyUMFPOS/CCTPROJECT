 ...
 */
class getMechanicsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MechanicsRepository' shared autowired service.
     *
     * @return \App\Repository\MechanicsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MechanicsRepository.php';

        return $container->privates['App\\Repository\\MechanicsRepository'] = new \App\Repository\MechanicsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
